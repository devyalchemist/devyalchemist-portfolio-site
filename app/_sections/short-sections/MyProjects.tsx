...
const MyProjects = () => {
	return (
		<div className="flex flex-col h-[20rem] sm:h-[40rem]">
			...
			<div className="relative bg-black sm:h-[12rem] h-[12rem] mt-4">
				...
				<div className="flex absolute right-4 bottom-4 justify-end  mt-12">
					<a href="#gallery">
