...
const HomeHeader = () => {
	...
	return (
		<div className=" top-0 z-1000 fixed w-full">
			<header className="flex   dark:text-white justify-between py-2 px-4 items-center bg-white/50 backdrop-blur-md border-b-[0.5px] border-black/10 ">
				<Link href={"/"}>
